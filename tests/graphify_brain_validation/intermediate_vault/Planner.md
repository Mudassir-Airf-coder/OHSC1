...
The Planner works closely with the [[Orchestrator]], which executes the plan, and the [[Reviewer]], which validates the result. Planner decisions are informed by a [[Knowledge Graph]] of available capabilities.
